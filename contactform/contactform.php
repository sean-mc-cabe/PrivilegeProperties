...
/***************** Configuration *****************/
  ...
  $contact_email_to = "enquiries@privilege-properties.com";

  // Title prefixes
  $subject_title = "PP Contact Form Message:";
  $name_title = "Name:";
  $email_title = "Email:";
...
/********** Do not edit from the below line ***********/
  ...
  if(isset($_POST)) {
    ...
    if(!$contact_email_to || $contact_email_to == 'lisa@privilege-properties.com') {
